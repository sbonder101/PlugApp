...
import 'package:plug/views/pages/auth/forgot_password.page.dart';
import 'package:plug/views/pages/auth/login.page.dart';
import 'package:plug/views/pages/auth/register.page.dart';
import 'package:plug/views/pages/chat/chat.page.dart';
import 'package:plug/views/pages/checkout/checkout.page.dart';
import 'package:plug/views/pages/delivery_address/delivery_addresses.page.dart';
import 'package:plug/views/pages/delivery_address/edit_delivery_addresses.page.dart';
import 'package:plug/views/pages/delivery_address/new_delivery_addresses.page.dart';
import 'package:plug/views/pages/favourite/favourites.page.dart';
import 'package:plug/views/pages/home.page.dart';
import 'package:plug/views/pages/order/orders_tracking.page.dart';
import 'package:plug/views/pages/profile/change_password.page.dart';
import 'package:plug/views/pages/vendor_details/vendor_details.page.dart';
import 'package:plug/views/pages/notification/notification_details.page.dart';
import 'package:plug/views/pages/notification/notifications.page.dart';
import 'package:plug/views/pages/onboarding.page.dart';
import 'package:plug/views/pages/order/orders_details.page.dart';
import 'package:plug/views/pages/product/product_details.page.dart';
import 'package:plug/views/pages/profile/edit_profile.page.dart';
import 'package:plug/views/pages/search/search.page.dart';
import 'package:plug/views/pages/wallet/wallet.page.dart';
