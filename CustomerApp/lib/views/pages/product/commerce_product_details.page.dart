...
import 'package:plug/views/pages/commerce/widgets/similar_commerce_products.view.dart';
import 'package:plug/views/pages/product/widgets/commerce_product_details.header.dart';
import 'package:plug/views/pages/product/widgets/commerce_product_details_cart.bottom_sheet.dart';
import 'package:plug/views/pages/product/widgets/commerce_product_options.dart';
import 'package:plug/views/pages/product/widgets/commerce_product_price.dart';
import 'package:plug/views/pages/product/widgets/commerce_product_qty.dart';
import 'package:plug/views/pages/product/widgets/commerce_seller_tile.dart';
import 'package:plug/views/pages/product/widgets/product_image.gallery.dart';
import 'package:plug/widgets/base.page.dart';
import 'package:plug/widgets/html_text_view.dart';
