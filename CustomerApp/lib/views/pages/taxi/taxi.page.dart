...
import 'package:plug/views/pages/taxi/widgets/new_order_step_1.dart';
import 'package:plug/views/pages/taxi/widgets/new_order_step_2.dart';
import 'package:plug/views/pages/taxi/widgets/taxi_rate_driver.view.dart';
import 'package:plug/views/pages/taxi/widgets/taxi_trip_ready.view.dart';
import 'package:plug/views/pages/taxi/widgets/trip_driver_search.dart';
import 'package:plug/views/pages/taxi/widgets/unsupported_taxi_location.view.dart';
          ...
          body: Stack(
            children: [
              ...
              Visibility(
                ...
                child: UnSupportedTaxiLocationView(vm),
              ),
