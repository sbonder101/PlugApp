...
<div class="relative"
    ...
    <p class="flex items-center px-6 py-3 text-white cursor-pointer" x-on:click="isOpen = !isOpen ">
        ...
        <?php if(!empty($icon)): ?>
            ...
            <?php if( isRTL() ): ?>
            <?php echo e(svg($icon)->class("w-5 h-5 ml-4")); ?>

            <?php else: ?>
            <?php echo e(svg($icon)->class("w-5 h-5 mr-4")); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'w-5 h-5','x-show' => 'isOpen']); ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
...
<?php /**PATH /home/sbonder/plug.sboniso.org.za/resources/views/components/group-menu-item.blade.php ENDPATH**/ ?>