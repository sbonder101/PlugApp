...
<html lang="{{ setting('localeCode', 'en') }}" dir="{{ isRTL() ? 'rtl':'ltr' }}"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css" nonce="">
...
<img src="{{ url( setting('websiteLogo', asset('images/logo.png') ) ) }}" alt="" width="140" height="140">
</td>
...
<p style="margin:0 0 9px;color:#2f313f;font-size:24px;line-height:30px;font-weight:bold!important;font-family:&#39;Google Sans&#39;,Helvetica,Arial"><b>{{ __('Hi') }} {{ $order->user->name }}!</b></p>
<p style="margin:0;color:#7c7d86;font-size:16px;line-height:20px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('This is your receipt.') }}</p>
</td>
</tr>
</tbody></table>
</td>
...
<span style="display:block;margin-top:0;margin-bottom:0;color:#7c7d86;font-size:14px;line-height:16px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('From') }}</span>
...
<a class="m_-7689638270191332508address-title">­{{ $order->vendor->address }}</a>
</div>
</td>
</tr>
...
<div style="margin:0 auto;max-width:600px;width:100%">
<span style="display:block;margin-top:0;margin-bottom:0;color:#7c7d86;font-size:14px;line-height:16px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('To') }}</span>
<a style="display:block;margin-top:4px;margin-bottom:5px;color:#2f313f!important;font-size:20px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial;text-decoration:none!important" class="m_-7689638270191332508address-title">­{{ $order->delivery_address != null ?$order->delivery_address->name: __('Customer Pickup') }}</a>
</div>
</td>
</tr>
<tr>
...
<tbody>
    ...
    <!-- <start order products!--  -->
        ...
        <tr>
            ...
            <p style="display:inline-block;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial;margin-top:0;margin-bottom:0">{{ currencyFormat($order->sub_total ?? '0.00') }}</p>
            </td>
            </tr>
        @else
...
<td style="vertical-align:top;text-align:right;padding:0;table-layout:fixed;max-width:80px;width:80px">
<p style="display:inline-block;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial;margin-top:0;margin-bottom:0">{{ currencyFormat($product->price) }}</p>
</td>
</tr>
...
<tr>
    ...
    <p style="margin-top:1px;margin-bottom:6px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('Subtotal') }}</p>
    </td>
    <td style="vertical-align:middle;text-align:right;padding:0">
    <p style="margin-top:1px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial"> {{ currencyFormat($order->sub_total ?? '0.00') }}</p>
    </td>
    </tr>
{{-- discount --}}
<tr>
    <td style="vertical-align:middle;padding:0">
    <p style="margin-top:1px;margin-bottom:6px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('Discount Amount') }}</p>
    </td>
    <td style="vertical-align:middle;text-align:right;padding:0">
    <p style="margin-top:1px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial"> - {{ currencyFormat($order->discount ?? '0.00') }}</p>
    </td>
    </tr>
{{-- delivery fee --}}
<tr>
<td style="vertical-align:middle;padding:0">
<p style="margin-top:1px;margin-bottom:6px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('Delivery fee') }}</p>
</td>
<td style="vertical-align:middle;text-align:right;padding:0">
<p style="margin-top:1px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">+ {{ currencyFormat($order->delivery_fee ?? '0.00') }}</p>
</td>
</tr>
{{-- tax --}}
<tr>
    <td style="vertical-align:middle;padding:0">
    <p style="margin-top:1px;margin-bottom:6px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('Tax') }}</p>
    </td>
    <td style="vertical-align:middle;text-align:right;padding:0">
    <p style="margin-top:1px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial"> + {{ currencyFormat($order->tax ?? '0.00') }}</p>
    </td>
    </tr>
<tr>
...
<tr>
<td style="vertical-align:middle;padding:0">
<p style="margin-top:6px;margin-bottom:6px;font-family:&#39;Google Sans&#39;,Helvetica,Arial;color:#2f313f;font-size:20px;line-height:30px"><b>{{ __('Total charged') }}:</b></p>
</td>
<td style="vertical-align:middle;text-align:right;padding:0">
<p style="margin-top:6px;margin-bottom:6px;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial;color:#2f313f;white-space:nowrap"><b>{{ currencyFormat($order->total ?? '0.00') }}</b></p>
</td>
</tr>
<tr>
    <td style="vertical-align:middle;padding:0">
    <p style="margin-top:6px;margin-bottom:6px;color:#2f313f;font-size:16px;line-height:24px;font-family:&#39;Google Sans&#39;,Helvetica,Arial">{{ __('Payment Method') }}</p>
    </td>
    <td style="vertical-align:middle;text-align:right;padding:0">
